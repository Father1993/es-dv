...
<html lang="ru">
    <head>
        ...
        <title>Ответвители - ООО "ТД"Электросистемы"</title>
        <meta
            name="description"
            content="Продажа ответвителей проводов производства TDM по низким ценам оптом и в розницу"
        />
        <meta
            name="keywords"
            content="Ответвители, оборудование, материалы, инструменты, проектирование, безопасность, качество"
        />

        <!-- Facebook Opengraph integration: https://developers.facebook.com/docs/sharing/opengraph -->
        <meta
            property="og:title"
            content="Ответвители - ООО ТД Электросистемы"
        />
        <meta
            property="og:image"
        ...
        <meta
            property="og:url"
            content="https://es-dv.ru/products/elektromontazhnye-izdeliya/14-otvetvitel.html"
        />
                            ...
                            <table style="height: 168px" width="100%">
                                <tbody>
                                    <tr>
                                        ...
                                        <th rowspan="2">
                                            Сечение провода — основной, мм<sup
                                                >2</sup
                                            >
                                        </th>
                                        <th rowspan="2">
