...
<html lang="ru">
    <head>
        ...
        <meta
            name="description"
            content="Недорогие пластиковые скобы для монтажа кабеля и провода"
        />
        <meta
            name="keywords"
        ...
        <meta
            property="og:title"
            content="Скобы пластиковые  - ООО ТД Электросистемы"
        />
        <meta
            property="og:image"
        ...
        <meta
            property="og:url"
            content="https://es-dv.ru/products/elektromontazhnye-izdeliya/21-skoby-plastikovye.html"
        />
                ...
                <div class="products-cabel__wrapper container">
                    <div class="products-cabel__wrapper-card">
                        <img
                            ...
                            src="./img/skoby-plastikovye.jpg"
                            alt="Скобы пластиковые"
                        />
