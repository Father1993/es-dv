...
$pageTitle = 'Площадки под хомуты - ООО ТД Электросистемы';

$pageDescription = 'Продажа качественных самоклеящихся площадок под хомуты для монтажа кабеля и провода';

$PageKeyWords = 'СИП, Инструменты, пвх, прокладка, монтаж, продажа, площадка, хомут, стяжка';

$ogUrl = 'https://es-dv.ru/products/elektromontazhnye-izdeliya/20-plosshadki-pod-khomuty.php';
