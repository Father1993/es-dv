...
<head>
    ...
    <title>Площадки под хомуты - ООО "ТД"Электросистемы"</title>
    <meta name="description"
        content="Продажа качественных самоклеящихся площадок под хомуты для монтажа кабеля и провода" />
    <meta name="keywords" content="СИП, Инструменты, пвх, прокладка, монтаж, продажа, площадка, хомут, стяжка" />

    <!-- Facebook Opengraph integration: https://developers.facebook.com/docs/sharing/opengraph -->
    <meta property="og:title" content="Площадки под хомуты - ООО ТД Электросистемы" />
    <meta property="og:image" content="https://es-dv.ru/assets/img/logo.png" />
    <meta property="og:url"
        content="https://es-dv.ru/products/elektromontazhnye-izdeliya/20-plosshadki-pod-khomuty.html" />
        ...
        <section class="products-cabel__items">
            <div class="products-cabel__wrapper container">
                <div class="products-cabel__wrapper-card">
                    <img class="products-cabel__img" src="./img/plosshadki-pod-khomuty.jpg" alt="Площадки под хомуты" />
                    <div class="products-cabel__title-wrapper">
                        <h2 class="products-cabel__title">
                            Площадки под хомуты
                        </h2>
                        <p class="products-cabel__text">
                            Продажа качественных самоклеящихся площадок под
                            хомуты для монтажа кабеля и провода.
                        </p>
                    </div>
                </div>
                ...
                <div class="products-cabel__about">
                    ...
                    <p>
                        Площадки под хомуты предназначены для крепления
                        стяжек, фиксирующих кабельные хомуты, к любой
                        плоской поверхности с помощью самоклеящегося слоя.
                        При необходимости (например, при производстве
                        наружных работ) площадка к поверхности закрепляется
                        с помощью винта или шурупа, для чего в площадке
                        предусмотрены отверстия.
                    </p>

                    <p>
                        Сделаны из полиамида (нейлона) белого цвета,
                        устойчивого к старению, коррозии, воздействию
                        ультрафиолета, солей, щелочей, масел, кислот,
                        бензина и спирта.
                    </p>
                    ...
                    <div class="flex__container revers-img">
                        <img style="width: 300px" src="./img/ltdm25.jpg" alt="Самоклеящиеся площадки под хомуты" />
                        <div>
                            <h4>Самоклеящиеся площадки под хомуты TDM</h4>

                            <div>
                                <table class="table-padding__four">
                                    <tbody>
                                        <tr>
                                            <th rowspan="2">Чертеж</th>
                                            <th rowspan="2">
                                                Наименование
                                            </th>
                                            <th rowspan="2">Артикул</th>
                                            <th rowspan="2">
                                                Ширина проема под хомут, мм
                                            </th>
                    ...
                    <div class="flex__container revers-img">
                        <img style="width: 300px" src="./img/iek40.jpg" alt="размеры площадки под хомуты" />
                        <div>
                            <h4>Самоклеящиеся площадки под хомуты IEK</h4>

                            <div>
                                <table class="table-padding__four" cellspacing="0" cellpadding="6">
                                    <tbody>
                                        <tr>
                                            <th rowspan="2">
                                                Наименование
                                            </th>
                                            <th colspan="4">Размеры, мм</th>
                                            <th rowspan="2">Цвет</th>
                                            <th rowspan="2">Материал</th>
                                            <th rowspan="2">
                                                Кол-во в упак.
                                        ...
                                        <tr>
                                            <td colspan="9">
                                                Площадки самоклеящиеся белые
                                                (100 шт)
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                Площадка самоклеящаяся 20x
                                                20 под хомуты
                                            </td>
                                            <td>20</td>
                                            <td>20</td>
