...
<html lang="ru">
    <head>
        ...
        <meta
            name="keywords"
            content="блок, защита, лампа, включение, подключение, светильник, нсп,наружный"
        />

        <!-- Facebook Opengraph integration: https://developers.facebook.com/docs/sharing/opengraph -->
        <meta
            property="og:title"
            content="Светильники серии НСП - ООО ТД Электросистемы"
        />
        <meta
            property="og:image"
        ...
        <meta
            property="og:url"
            content="https://es-dv.ru/products/svet/51-svetilniki-serii-nsp.html"
        />
                ...
                <div class="products-cabel__wrapper container">
                    <div class="products-cabel__wrapper-card">
                        <img
                            ...
                            src="./img/svetilniki-serii-nsp.jpg"
                            alt="Светильники серии НСП"
                        />
