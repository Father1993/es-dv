...
<html lang="ru">
    <head>
        ...
        <meta
            property="og:title"
            content="Светильники серии ЛКУ11 - ООО ТД Электросистемы"
        />
        <meta
            property="og:image"
        ...
        <meta
            property="og:url"
            content="https://es-dv.ru/products/svet/4-svetilniki-serii-lku11.html"
        />
                ...
                <div class="products-cabel__wrapper container">
                    <div class="products-cabel__wrapper-card">
                        <img
                            ...
                            src="./img/svetilniki-serii-lku11.jpg"
                            alt="Светильники серии ЛКУ11"
                        />
                        <div class="products-cabel__title-wrapper">
                            <h2 class="products-cabel__title">
                                Светильники серии ЛКУ11
                            </h2>
                            <p class="products-cabel__text">
                                Приобрести надежные уличные светильники TDM
                                серии ЛКУ11 по отличным ценам вы можете в
                    ...
                    <div class="products-cabel__about">
                        ...
                        <p>
                            Уличные светильники серии ЛКУ11 с КЛЛ применяются
                            для освещения частных секторов, жилого
                            строительства, автомобильных стоянок, территорий
                            дворов, школ и детских садов.
                        </p>
                        ...
                        <ul>
                            <li>
                                повышенная эффективность светового потока лампы
                                за счет наличия отражателя из анодированного
                                алюминия
                            </li>
                            <li>
                                корпус светильника не подвержен коррозии,
                                термостойкий рассеиватель из закаленного стекла
                                не мутнеет и не подвержен влиянию высоких/низких
                                температур
                            </li>
                            <li>стандартное крепление на трубу d=48 мм</li>
                            <li>
                                светильник прост и удобен в монтаже и
                                обслуживании
                            </li>
                        </ul>
                        <p
                            ...
                            "
                        >
                            Лучшей альтернативой традиционным уличным
                            светильникам могут стать LED-светильники
                        </p>
                        <p>
                            <strong
