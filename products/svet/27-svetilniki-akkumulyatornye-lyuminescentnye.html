...
<html lang="ru">
    <head>
        ...
        <meta
            name="description"
            content="Продажа аккумуляторных люминесцентных светильников оптом и в розницу"
        />
        <meta
            name="keywords"
        ...
        <meta
            property="og:title"
            content="Светильники аккумуляторные люминесцентные - ООО ТД Электросистемы"
        />
        <meta
            property="og:image"
                ...
                <div class="products-cabel__wrapper container">
                    <div class="products-cabel__wrapper-card">
                        <img
                            ...
                            src="./img/svetilniki-akkumulyatornye-lyuminescentnye.jpg"
