...
<html lang="ru">
    <head>
        ...
        <meta
            property="og:title"
            content="Светильники серии НПБ - ООО ТД Электросистемы"
        />
        <meta
            property="og:image"
        ...
        <meta
            property="og:url"
            content="https://es-dv.ru/products/svet/5-svetilniki-serii-npb.html"
        />
                ...
                <div class="products-cabel__wrapper container">
                    <div class="products-cabel__wrapper-card">
                        <img
                            ...
                            src="./img/svetilniki-serii-npb.jpg"
                            alt="Светильники серии НПБ"
                        />
