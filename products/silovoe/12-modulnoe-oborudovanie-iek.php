...
$pageTitle = 'Модульное оборудование IEK- ООО ТД Электросистемы';

$pageDescription = 'Модульное оборудование IEK представлено в широком ассортименте: автоматические выключатели, устройства дифференциальной защиты и дополнительные модульные устройства. IEK - это надежная и качественная продукция по приемлемым ценам';

$PageKeyWords = 'выключатель, автоматический, дифференциальный, иэк, iek, выключатель нагрузки, предохранитель, контактор, контакт, ограничитель, расцепитель,переходник, таймер цифровой, таймер аналоговый, звонок, индикатор фаз, модульное оборудование, автомат';

$ogUrl = 'https://es-dv.ru/products/silovoe/12-modulnoe-oborudovanie-iek.php';
