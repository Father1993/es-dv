...
<html lang="ru">
    <head>
        ...
        <title>Силовые разъемы - ООО "ТД"Электросистемы"</title>
        <meta
            name="description"
            content="Вилки, стационарные и переносные розетки для подключения различного электрооборудования, электроинструмента, станков и пр. по низким ценам"
        />
        <meta
            name="keywords"
            content="модульное оборудование, разъемы, силовые , автоматические выключатели, дифференциальные автоматы, выключатели нагрузки, ограничители перенапряжений, модульные контакторы, сигнальные лампы, розетки модульные"
        />

        <!-- Facebook Opengraph integration: https://developers.facebook.com/docs/sharing/opengraph -->
        <meta
            property="og:title"
            content="Силовые разъемы- ООО ТД Электросистемы"
        />
        <meta
            property="og:image"
        ...
        <meta
            property="og:url"
            content="https://es-dv.ru/products/silovoe/22-silovye-razemy.html"
        />
                ...
                <div class="products-cabel__wrapper container">
                    ...
                    <div class="products-cabel__about">
                        ...
                        <ul>
                            ...
                            <li>
                                штыревые контакты
                                <a href="../electro-ustanovka/vilki.php"
                                    >вилок</a
                                >
                        ...
                        <span class="span-spec__border"
                            >Смотрите также розетки
                            <a href="../electro-ustanovka/rozetki-tdm.php"
                                >TDM</a
                            >,
                            <a href="../electro-ustanovka/systeme-electric.php"
                                >розетки Schneider</a
                            ></span
                        >
                    </div>
