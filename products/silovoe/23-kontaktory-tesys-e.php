...
<head>
    ...
    <title>
        Контакторы и тепловые реле перегрузки TeSys E Schneider Electric -
        ООО "ТД"Электросистемы"
    </title>
    <meta name="description"
        content="Контакторы и тепловые реле перегрузки TeSys E Schneider Electric от официального представителя по низким ценам." />
    <meta name="keywords"
        content="модульное оборудование, Контакторы, тепловые реле, перегрузки, TeSys E, Schneider Electric, ограничители перенапряжений, модульные контакторы, сигнальные лампы, розетки модульные" />

    <!-- Facebook Opengraph integration: https://developers.facebook.com/docs/sharing/opengraph -->
    <meta property="og:title"
        content="Контакторы и тепловые реле перегрузки TeSys E Schneider Electric- ООО ТД Электросистемы" />
    <meta property="og:image" content="https://es-dv.ru/assets/img/logo.png" />
    <meta property="og:url" content="https://es-dv.ru/products/silovoe/23-kontaktory-tesys-e.html" />
            ...
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <ol>
                        ...
                        <li>
                            Контакторы и тепловые реле перегрузки TeSys E
                            Schneider Electric
                        </li>
                    </ol>
                </div>
        ...
        <section class="products-cabel__items">
            <div class="products-cabel__wrapper container">
                <div class="products-cabel__wrapper-card">
                    <img class="products-cabel__img" src="./img/kontaktory-tesys-e.jpg"
                        alt="Контакторы и тепловые реле перегрузки TeSys E Schneider Electric" />
                    <div class="products-cabel__title-wrapper">
                        ...
                        <p class="products-cabel__text">
                            Cерия контакторов TeSys E разработана на базе
                            знаменитых европейских пускателей серий TeSys F
                            и TeSys D и является их упрощенной модификацией.
                        </p>
                    </div>
                </div>
                ...
                <div class="products-cabel__about">
                    ...
                    <p>
                        <a href="27-kontaktory.php">Контакторы</a> TeSys
                        E предназначены для применениях в схемах управления
                        электроприводами на напряжение питания до 690 В
                        переменного тока с частотой 50 и 60 Гц в категориях
                        применения АС3 и АС1.
                    </p>

                    <p>
                        При наличии тепловых реле (LRE48) или
                        <a href="25-avtomaticheskie-vyklyuchateli.php">автоматических выключателей</a>
                        (Easypact) пускатели TeSys E осуществляют защиту
